...
import { ComboBox, RichEditor } from "../custom";
...
const EditCourseForm = ({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      await axios.patch(`/api/courses/${course.id}`, values); // change specific value
                    ...
                    <FormControl>
                      <ComboBox
                        options={
                          categories.find(
                            (categoryId) =>
                              categoryId.value === form.watch("categoryId")
                          )?.subCategories || []
                        }
                        {...field}
                      />
                ...
                <FormItem className="flex flex-col gap-2">
                  ...
                  <FormControl>
                    <FileUpload
                      ...
                      page="Edit Course"
                      onRemove={(idToRemoveImage: string) =>
                        idToRemoveImage === field.value && field.onChange("")
                      }
                    />
                  </FormControl>
                  <FormMessage />
