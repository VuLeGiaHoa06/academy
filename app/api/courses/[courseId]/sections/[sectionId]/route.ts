import { stringify } from "./../../../../../../node_modules/hls.js/src/utils/safe-json-stringify";
...
export const POST = async (
  ...
  try {
    ...
    if (!values)
      return new NextResponse("Dont have enough values", { status: 404 });
...
export const DELETE = async (
  ...
  try {
    ...
    return new NextResponse("Section is deleted", { status: 200 });
  } catch (error) {
